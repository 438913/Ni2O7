...
def get_double_append(i,n,s1,o1,x1,y1,z1,s2,o2,x2,y2,z2,s3,o3,x3,y3,z3,
                      ...
                      d_list,idx,hole3456_part, double_part):
    if o1 in pam.Ni_orbs and o2 in pam.Ni_orbs: #and not (o3 in pam.Ni_Cu_orbs and o4 in pam.Ni_Cu_orbs and ...):
        if (x3, y3) != (x1, y1) and (x4, y4) != (x1, y1) and (x5, y5) != (x1, y1) and (x6, y6) != (x1, y1):
            d_list.append(i)
        ...
        for j in l2: 
            for k in l3:
                for h in l4:
                    for g in l5:
                        for f in l6:
                            x = lambda i=i, j=j, k=k, h=h, g=g, f=f: (i,j,k,h,g,f)
                            funs.append(x)
