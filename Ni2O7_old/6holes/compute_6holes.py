...
def compute_Aw_main(A, ep, tpd, tpp, tz_a1a1, tz_b1b1, pds, pdp, pps, ppp, Upp, \
    ...
    if Norb == 4 or Norb == 7 or Norb == 10 or Norb == 11 or Norb == 12:
        Hint_000 = ham.create_interaction_matrix_ALL_syms(VS, d_000_double, double_000_part, idx_000,
                                                          hole345_000_part, \
                                                          S_000_val, Sz_000_val, AorB_000_sym, A)
        Hint_200 = ham.create_interaction_matrix_ALL_syms(VS, d_200_double, double_200_part, idx_200,
                                                          hole345_200_part, \
                                                          S_200_val, Sz_200_val, AorB_200_sym, A)
