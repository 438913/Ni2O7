            ...
            for dir_ in tpd_nn_hop_dir[orb1]:
                ...
                for o1 in orbs1:
                    ...
                    slabel = [s1, o1, x1 + vx, y1 + vy, z1 + vz, s2, orb2, x2, y2, z2, s3, orb3, x3, y3, z3, s4, orb4,
                              x4, y4, z4, s5, orb5, x5, y5, z5, s6, orb6, x6, y6, z6]
            ...
            for dir_ in tpd_nn_hop_dir[orb4]:
                ...
                for o4 in orbs4:
                    ...
                    slabel = [s1, orb1, x1, y1, z1, s2, orb2, x2, y2, z2, s3, orb3, x3, y3, z3, s4, o4, x4 + vx,
                              y4 + vy, z4 + vz, s5, orb5, x5, y5, z5, s6, orb6, x6, y6, z6]
                    if not vs.check_Pauli(slabel):
                        continue
            ...
            for dir_ in tpd_nn_hop_dir[orb5]:
                ...
                for o5 in orbs5:
                    ...
                    slabel = [s1, orb1, x1, y1, z1, s2, orb2, x2, y2, z2, s3, orb3, x3, y3, z3, s4, orb4, x4, y4, z4,
                              s5, o5, x5 + vx, y5 + vy, z5 + vz, s6, orb6, x6, y6, z6]
                    if not vs.check_Pauli(slabel):
                        continue
        ...
        if orb6 in tpd_orbs:
            for dir_ in tpd_nn_hop_dir[orb6]:
                ...
                for o6 in orbs6:
                    ...
                    # consider Pauli principle
                    slabel = [s1, orb1, x1, y1, z1, s2, orb2, x2, y2, z2, s3, orb3, x3, y3, z3, s4, orb4, x4, y4, z4,
                              s5, orb5, x5, y5, z5, s6, o6, x6 + vx, y6 + vy, z6 + vz]
                    if not vs.check_Pauli(slabel):
                        continue
            ...
            for dir_ in tpp_nn_hop_dir:
                ...
                for o3 in orbs3:
                    ...
                    slabel = [s1, orb1, x1, y1, z1, s2, orb2, x2, y2, z2, s3, o3, x3 + vx, y3 + vy, z3 + vz,
                              s4, orb4,x4, y4, z4, s5, orb5, x5, y5, z5, s6, orb6, x6, y6, z6]
                    if not vs.check_Pauli(slabel):
                        continue
            ...
            for dir_ in tpp_nn_hop_dir:
                ...
                for o4 in orbs4:
                    ...
                    slabel = [s1, orb1, x1, y1, z1, s2, orb2, x2, y2, z2, s3, orb3, x3, y3, z3,
                              s4, o4, x4 + vx,y4 + vy, z4 + vz, s5, orb5, x5, y5, z5, s6, orb6, x6, y6, z6]
                    if not vs.check_Pauli(slabel):
                        continue
        ...
        if orb5 in pam.O_orbs:
            for dir_ in tpp_nn_hop_dir:
                ...
                for o5 in orbs5:
                    # consider Pauli principle
                    slabel = [s1, orb1, x1, y1, z1, s2, orb2, x2, y2, z2, s3, orb3, x3, y3, z3,
                              s4, orb4, x4, y4, z4,s5, o5, x5 + vx, y5 + vy, z5 + vz, s6, orb6, x6, y6, z6]
                    if not vs.check_Pauli(slabel):
                        continue
        ...
        if orb6 in pam.O_orbs:
            for dir_ in tpp_nn_hop_dir:
                ...
                for o6 in orbs6:
                    # consider Pauli principle
                    slabel = [s1, orb1, x1, y1, z1, s2, orb2, x2, y2, z2, s3, orb3, x3, y3, z3,
                              s4, orb4, x4, y4, z4, s5, orb5, x5, y5, z5, s6, o6, x6 + vx, y6 + vy, z6 + vz]
                    if not vs.check_Pauli(slabel):
                        continue
...
def create_edep_diag_matrix(VS, A, ep):
    ...
    for i in range(dim):
        ...
        diag_el += util.get_orb_edep(orb6, z6, ep)
...
def get_double_occu_list(VS):
    ...
    '''
    dim = VS.dim
    d_Ni1_list = [];idx_Ni1 = [];hole3456_Ni1_part = [];double_Ni1_part = [];
    d_Ni2_list = [];idx_Ni2 = [];hole3456_Ni2_part = [];double_Ni2_part = [];
    p_list = [];apz_list = []
    ...
    for i in range(0, dim):
        ...
        if (x1, y1, z1) == (x2, y2, z2):
            if x1 == -1:
                util.get_double_append(i, 3456, s1, o1, x1, y1, z1, s2, o2, x2, y2, z2, s3, o3, x3, y3, z3,
                                       s4, o4, x4,y4, z4, s5, o5, x5, y5, z5, s6, o6, x6, y6, z6,
                                       d_Ni1_list, idx_Ni1, hole3456_Ni1_part, double_Ni1_part)
            elif x1 == 1:
                util.get_double_append(i, 3456, s1, o1, x1, y1, z1, s2, o2, x2, y2, z2, s3, o3, x3, y3, z3,
                                       s4, o4, x4,y4, z4, s5, o5, x5, y5, z5, s6, o6, x6, y6, z6,
        ...
        if (x1, y1, z1) == (x3, y3, z3):
            if x1 == -1:
                util.get_double_append(i, 2456, s1, o1, x1, y1, z1, s3, o3, x3, y3, z3, s2, o2, x2, y2, z2,
                                       s4, o4, x4,y4, z4, s5, o5, x5, y5, z5, s6, o6, x6, y6, z6,
                                       d_Ni1_list, idx_Ni1, hole3456_Ni1_part, double_Ni1_part)
            elif x1 == 1:
                util.get_double_append(i, 2456, s1, o1, x1, y1, z1, s3, o3, x3, y3, z3, s2, o2, x2, y2, z2,
                                       s4, o4, x4,y4, z4, s5, o5, x5, y5, z5, s6, o6, x6, y6, z6,
                                       d_Ni2_list, idx_Ni2, hole3456_Ni2_part, double_Ni2_part)
            if o1 in pam.O_orbs and o3 in pam.O_orbs:
                p_list.append(i)

        if (x1, y1, z1) == (x4, y4, z4):
            if x1 == -1:
                util.get_double_append(i, 2356, s1, o1, x1, y1, z1, s4, o4, x4, y4, z4, s2, o2, x2, y2, z2,
                                       s3, o3, x3,y3, z3, s5, o5, x5, y5, z5, s6, o6, x6, y6, z6,
                                       d_Ni1_list, idx_Ni1, hole3456_Ni1_part, double_Ni1_part)
            elif x1 == 1:
                util.get_double_append(i, 2356, s1, o1, x1, y1, z1, s4, o4, x4, y4, z4, s2, o2, x2, y2, z2,
                                       s3, o3, x3,y3, z3, s5, o5, x5, y5, z5, s6, o6, x6, y6, z6,
                                       d_Ni2_list, idx_Ni2, hole3456_Ni2_part, double_Ni2_part)
            if o1 in pam.O_orbs and o4 in pam.O_orbs:
                p_list.append(i)

        if (x2, y2, z2) == (x3, y3, z3):
            if x2 == -1:
                util.get_double_append(i, 1456, s2, o2, x2, y2, z2, s3, o3, x3, y3, z3, s1, o1, x1, y1, z1,
                                       s4, o4, x4,y4, z4, s5, o5, x5, y5, z5, s6, o6, x6, y6, z6,
                                       d_Ni1_list, idx_Ni1, hole3456_Ni1_part, double_Ni1_part)
            elif x2 == 1:
                util.get_double_append(i, 1456, s2, o2, x2, y2, z2, s3, o3, x3, y3, z3, s1, o1, x1, y1, z1,
                                       s4, o4, x4,y4, z4, s5, o5, x5, y5, z5, s6, o6, x6, y6, z6,
                                       d_Ni2_list, idx_Ni2, hole3456_Ni2_part, double_Ni2_part)
            if o2 in pam.O_orbs and o3 in pam.O_orbs:
                p_list.append(i)

        if (x2, y2, z2) == (x4, y4, z4):
            if x2 == -1:
                util.get_double_append(i, 1356, s2, o2, x2, y2, z2, s4, o4, x4, y4, z4, s1, o1, x1, y1, z1,
                                       s3, o3, x3,y3, z3, s5, o5, x5, y5, z5, s6, o6, x6, y6, z6,
                                       d_Ni1_list, idx_Ni1, hole3456_Ni1_part, double_Ni1_part)
            elif x2 == 1:
                util.get_double_append(i, 1356, s2, o2, x2, y2, z2, s4, o4, x4, y4, z4, s1, o1, x1, y1, z1,
                                       s3, o3, x3,y3, z3, s5, o5, x5, y5, z5, s6, o6, x6, y6, z6,
                                       d_Ni2_list, idx_Ni2, hole3456_Ni2_part, double_Ni2_part)
            if o2 in pam.O_orbs and o4 in pam.O_orbs:
                p_list.append(i)

        if (x3, y3, z3) == (x4, y4, z4):
            if x3 == -1:
                util.get_double_append(i, 1256, s3, o3, x3, y3, z3, s4, o4, x4, y4, z4, s1, o1, x1, y1, z1,
                                       s2, o2, x2,y2, z2, s5, o5, x5, y5, z5, s6, o6, x6, y6, z6,
                                       d_Ni1_list, idx_Ni1, hole3456_Ni1_part, double_Ni1_part)
            elif x3 == 1:
                util.get_double_append(i, 1256, s3, o3, x3, y3, z3, s4, o4, x4, y4, z4, s1, o1, x1, y1, z1,
                                       s2, o2, x2,y2, z2, s5, o5, x5, y5, z5, s6, o6, x6, y6, z6,
                                       d_Ni2_list, idx_Ni2, hole3456_Ni2_part, double_Ni2_part)
            if o3 in pam.O_orbs and o4 in pam.O_orbs:
                p_list.append(i)

        if (x1, y1, z1) == (x5, y5, z5):
            if x1 == -1:
                util.get_double_append(i, 2346, s1, o1, x1, y1, z1, s5, o5, x5, y5, z5, s2, o2, x2, y2, z2,
                                       s3, o3, x3,y3, z3, s4, o4, x4, y4, z4, s6, o6, x6, y6, z6,
                                       d_Ni1_list, idx_Ni1, hole3456_Ni1_part, double_Ni1_part)
            elif x1 == 1:
                util.get_double_append(i, 2346, s1, o1, x1, y1, z1, s5, o5, x5, y5, z5, s2, o2, x2, y2, z2,
                                       s3, o3, x3,y3, z3, s4, o4, x4, y4, z4, s6, o6, x6, y6, z6,
                                       d_Ni2_list, idx_Ni2, hole3456_Ni2_part, double_Ni2_part)
            if o1 in pam.O_orbs and o5 in pam.O_orbs:
                p_list.append(i)

        if (x2, y2, z2) == (x5, y5, z5):
            if x2 == -1:
                util.get_double_append(i, 1346, s2, o2, x2, y2, z2, s5, o5, x5, y5, z5, s1, o1, x1, y1, z1,
                                       s3, o3, x3,y3, z3, s4, o4, x4, y4, z4, s6, o6, x6, y6, z6,
                                       d_Ni1_list, idx_Ni1, hole3456_Ni1_part, double_Ni1_part)
            elif x2 == 1:
                util.get_double_append(i, 1346, s2, o2, x2, y2, z2, s5, o5, x5, y5, z5, s1, o1, x1, y1, z1,
                                       s3, o3, x3,y3, z3, s4, o4, x4, y4, z4, s6, o6, x6, y6, z6,
                                       d_Ni2_list, idx_Ni2, hole3456_Ni2_part, double_Ni2_part)
            if o2 in pam.O_orbs and o5 in pam.O_orbs:
                p_list.append(i)

        if (x3, y3, z3) == (x5, y5, z5):
            if x3 == -1:
                util.get_double_append(i, 1246, s3, o3, x3, y3, z3, s5, o5, x5, y5, z5, s1, o1, x1, y1, z1,
                                       s2, o2, x2,y2, z2, s4, o4, x4, y4, z4, s6, o6, x6, y6, z6,
                                       d_Ni1_list, idx_Ni1, hole3456_Ni1_part, double_Ni1_part)
            elif x3 == 1:
                util.get_double_append(i, 1246, s3, o3, x3, y3, z3, s5, o5, x5, y5, z5, s1, o1, x1, y1, z1,
                                       s2, o2, x2,y2, z2, s4, o4, x4, y4, z4, s6, o6, x6, y6, z6,
                                       d_Ni2_list, idx_Ni2, hole3456_Ni2_part, double_Ni2_part)
            if o3 in pam.O_orbs and o5 in pam.O_orbs:
                p_list.append(i)

        if (x4, y4, z4) == (x5, y5, z5):
            if x4 == -1:
                util.get_double_append(i, 1236, s4, o4, x4, y4, z4, s5, o5, x5, y5, z5, s1, o1, x1, y1, z1,
                                       s2, o2, x2,y2, z2, s3, o3, x3, y3, z3, s6, o6, x6, y6, z6,
                                       d_Ni1_list, idx_Ni1, hole3456_Ni1_part, double_Ni1_part)
            elif x4 == 1:
                util.get_double_append(i, 1236, s4, o4, x4, y4, z4, s5, o5, x5, y5, z5, s1, o1, x1, y1, z1,
                                       s2, o2, x2,y2, z2, s3, o3, x3, y3, z3, s6, o6, x6, y6, z6,
                                       d_Ni2_list, idx_Ni2, hole3456_Ni2_part, double_Ni2_part)
            if o4 in pam.O_orbs and o5 in pam.O_orbs:
                p_list.append(i)
        if (x1, y1, z1) == (x6, y6, z6):
            if x1 == -1:
                util.get_double_append(i, 2345, s1, o1, x1, y1, z1, s6, o6, x6, y6, z6, s2, o2, x2, y2, z2,
                                       s3, o3, x3,y3, z3, s4, o4, x4, y4, z4, s5, o5, x5, y5, z5,
                                       d_Ni1_list, idx_Ni1, hole3456_Ni1_part, double_Ni1_part)
            elif x1 == 1:
                util.get_double_append(i, 2345, s1, o1, x1, y1, z1, s6, o6, x6, y6, z6, s2, o2, x2, y2, z2,
                                       s3, o3, x3,y3, z3, s4, o4, x4, y4, z4, s5, o5, x5, y5, z5,
                                       d_Ni2_list, idx_Ni2, hole3456_Ni2_part, double_Ni2_part)
            if o1 in pam.O_orbs and o6 in pam.O_orbs:
                p_list.append(i)

        if (x2, y2, z2) == (x6, y6, z6):
            if x2 == -1:
                util.get_double_append(i, 1345, s2, o2, x2, y2, z2, s6, o6, x6, y6, z6, s1, o1, x1, y1, z1,
                                       s3, o3, x3,y3, z3, s4, o4, x4, y4, z4, s5, o5, x5, y5, z5,
                                       d_Ni1_list, idx_Ni1, hole3456_Ni1_part, double_Ni1_part)
            elif x2 == 1:
                util.get_double_append(i, 1345, s2, o2, x2, y2, z2, s6, o6, x6, y6, z6, s1, o1, x1, y1, z1,
                                       s3, o3, x3,y3, z3, s4, o4, x4, y4, z4, s5, o5, x5, y5, z5,
                                       d_Ni2_list, idx_Ni2, hole3456_Ni2_part, double_Ni2_part)
            if o2 in pam.O_orbs and o6 in pam.O_orbs:
                p_list.append(i)

        if (x3, y3, z3) == (x6, y6, z6):
            if x3 == -1:
                util.get_double_append(i, 1245, s3, o3, x3, y3, z3, s6, o6, x6, y6, z6, s1, o1, x1, y1, z1,
                                       s2, o2, x2,y2, z2, s4, o4, x4, y4, z4, s5, o5, x5, y5, z5,
                                       d_Ni1_list, idx_Ni1, hole3456_Ni1_part, double_Ni1_part)
            elif x3 == 1:
                util.get_double_append(i, 1245, s3, o3, x3, y3, z3, s6, o6, x6, y6, z6, s1, o1, x1, y1, z1,
                                       s2, o2, x2,y2, z2, s4, o4, x4, y4, z4, s5, o5, x5, y5, z5,
                                       d_Ni2_list, idx_Ni2, hole3456_Ni2_part, double_Ni2_part)
            if o3 in pam.O_orbs and o6 in pam.O_orbs:
                p_list.append(i)

        if (x4, y4, z4) == (x6, y6, z6):
            if x4 == -1:
                util.get_double_append(i, 1235, s4, o4, x4, y4, z4, s6, o6, x6, y6, z6, s1, o1, x1, y1, z1,
                                       s2, o2, x2,y2, z2, s3, o3, x3, y3, z3, s5, o5, x5, y5, z5,
                                       d_Ni1_list, idx_Ni1, hole3456_Ni1_part, double_Ni1_part)
            elif x4 == 1:
                util.get_double_append(i, 1235, s4, o4, x4, y4, z4, s6, o6, x6, y6, z6, s1, o1, x1, y1, z1,
                                       s2, o2, x2,y2, z2, s3, o3, x3, y3, z3, s5, o5, x5, y5, z5,
                                       d_Ni2_list, idx_Ni2, hole3456_Ni2_part, double_Ni2_part)
            if o4 in pam.O_orbs and o6 in pam.O_orbs:
                p_list.append(i)

        if (x5, y5, z5) == (x6, y6, z6):
            if x5 == -1:
                util.get_double_append(i, 1234, s5, o5, x5, y5, z5, s6, o6, x6, y6, z6, s1, o1, x1, y1, z1,
                                       s2, o2, x2,y2, z2, s3, o3, x3, y3, z3, s4, o4, x4, y4, z4,
                                       d_Ni1_list, idx_Ni1, hole3456_Ni1_part, double_Ni1_part)
            elif x5 == 1:
                util.get_double_append(i, 1234, s5, o5, x5, y5, z5, s6, o6, x6, y6, z6, s1, o1, x1, y1, z1,
                                       s2, o2, x2,y2, z2, s3, o3, x3, y3, z3, s4, o4, x4, y4, z4,
                                       d_Ni2_list, idx_Ni2, hole3456_Ni2_part, double_Ni2_part)
            if o5 in pam.O_orbs and o6 in pam.O_orbs:
                p_list.append(i)
    ...
    return d_Ni1_list, idx_Ni1, hole3456_Ni1_part, double_Ni1_part, \
        d_Ni2_list, idx_Ni2, hole3456_Ni2_part, double_Ni2_part, \
        p_list


def create_interaction_matrix_ALL_syms(VS, d_double, double_part, idx, hole3456_part, S_val, Sz_val, AorB_sym,
                                       A):
    '''
    ...
    '''
    t1 = time.time()
    print("start create_interaction_matrix_ALL_syms (six holes)")
    print("======================================================")
        ...
        for i, double_id in enumerate(d_double):
            ...
            for idx2, o34 in enumerate(sym_orbs):
                ...
                for s1 in ('up', 'dn'):
                    for s2 in ('up', 'dn'):
                        if idx[i] == 3456:
                            slabel = [s1, o34[0]] + dpos + [s2, o34[1]] + dpos + hole3456_part[i][0:20]
                        if idx[i] == 2456:
                        ...
                        if idx[i] == 1356:
                            slabel = hole3456_part[i][0:5] + [s1, o34[0]] + dpos + hole3456_part[i][5:10] + [s2, o34[1]] + dpos + hole3456_part[i][10:20]
                        if idx[i] == 1256:
                        ...
                        if idx[i] == 1246:
                            slabel = hole3456_part[i][0:10] + [s1, o34[0]] + dpos + hole3456_part[i][10:15] + [s2, o34[1]] + dpos + hole3456_part[i][15:20]
                        if idx[i] == 1346:
                            slabel = hole3456_part[i][0:5] + [s1, o34[0]] + dpos + hole3456_part[i][5:15] + [s2, o34[1]] + dpos + hole3456_part[i][15:20]
                        if idx[i] == 2346:
...
def create_interaction_matrix_p(VS, p_double, Upp):
    ...
    col = np.array(col)
    data = np.array(data)
    return sps.coo_matrix((data, (row, col)), shape=(dim, dim))
