...
def get_double_append(i,n,s1,o1,x1,y1,z1,s2,o2,x2,y2,z2,s3,o3,x3,y3,z3,s4,o4,x4,y4,z4,
                      d_list,idx,hole34_part, double_part):
    if o1 in pam.Ni_orbs and o2 in pam.Ni_orbs: #and not (o3 in pam.Ni1_orbs and o4 in pam.Ni2_orbs):
        if (x3, y3) != (x1, y1) and (x4, y4) != (x1, y1):
            d_list.append(i)
