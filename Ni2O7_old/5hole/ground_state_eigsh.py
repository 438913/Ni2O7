...
#             print (slabel)
            slabel= make_x_canonical(slabel)
            s1 = slabel[0]; orb1 = slabel[1]; x1 = slabel[2]; y1 = slabel[3]; z1 = slabel[4];
            s2 = slabel[5]; orb2 = slabel[6]; x2 = slabel[7]; y2 = slabel[8]; z2 = slabel[9];
            s3 = slabel[10]; orb3 = slabel[11]; x3 = slabel[12]; y3 = slabel[13]; z3 = slabel[14];
            s4 = slabel[15]; orb4 = slabel[16]; x4 = slabel[17]; y4 = slabel[18]; z4 = slabel[19];
           ...
           # 修改过的代码
            state1 = [(orb1, x1, y1), (orb2, x2, y2), (orb3, x3, y3), (orb4, x4, y4), (orb5, x5, y5)]
            state_type_key = state_classification(state1)
            ...
            #
            #
            # elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.Ni_orbs) and (orb4 in pam.Ni_orbs) and (orb5 in pam.O_orbs) and x1==x2==-1 and x3==x4==1 and ((abs(x5+1) + abs(y5-0))==1 and (x5,y5)!=(0,0)):
            ...
            #
            #
            # elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.Ni_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==-1 and x2==x3==1 and ((abs(x4+1) + abs(y4-0))==1) and ((abs(x5-1) + abs(y5-0))==1 and (x4,y4)!=(0,0) and (x5,y5)!=(0,0)):
            ...
            #
            #
            # elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.Ni_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==x2==-1 and x3==1 and ((abs(x4+1) + abs(y4-0))==1) and ((abs(x5-1) + abs(y5-0))==1 and (x4,y4)!=(0,0) and (x5,y5)!=(0,0)):
            ...
            #
            #
            # elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.Ni_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==-1 and x2==x3==1 and ((abs(x4+1) + abs(y4-0))==1) and ((abs(x5+1) + abs(y5-0))==1):
            ...
            #
            #
            # elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.Ni_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==x2==-1 and x3==1 and ((abs(x4-1) + abs(y4-0))==1 ) and ((abs(x5-1) + abs(y5-0))==1):
            ...
            #
            # elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.Ni_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==-1 and x2==x3==1 and ((abs(x4-1) + abs(y4-0))==1 and (x4,y4)!=(0,0)) and ((abs(x5-1) + abs(y5-0))==1 and (x5,y5)!=(0,0)):
            #     wgt_d9d8L2[0]+=abs(vecs[istate,k])**2
            # elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and (orb3 in pam.Ni_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1 == x2 == -1 and x3 == 1 and ((abs(x4 + 1) + abs(y4 - 0)) == 1) and (x4, y4) != (0, 0) and ((abs(x5 + 1) + abs(y5 - 0)) == 1 and (x5, y5) != (0, 0)):
            #     wgt_d8L2d9[0] += abs(vecs[istate, k]) ** 2
            # elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.O_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==-1 and x2==1 and ((abs(x3-1) + abs(y3-0))==1 and (x3,y3)!=(0,0)) and ((abs(x4-1) + abs(y4-0))==1 and (x4,y4)!=(0,0)) and ((abs(x5-1) + abs(y5-0))==1 and (x5,y5)!=(0,0)):
            ...
            #
            #
            # elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.O_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==-1 and x2==1 and ((abs(x3+1) + abs(y3-0))==1) and ((abs(x4+1) + abs(y4-0))==1) and ((abs(x5-1) + abs(y5-0))==1 and (x3, y3) != (0, 0) and (x4, y4) != (0, 0) and (x5,y5)!=(0,0)):
            ...
            #
            # elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.O_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==x2==-1 and ((abs(x3-1) + abs(y3-0))==1 and (x3,y3)!=(0,0)) and ((abs(x4-1) + abs(y4-0))==1 and (x4,y4)!=(0,0)) and ((abs(x5-1) + abs(y5-0))==1 and (x5,y5)!=(0,0)):
            #     wgt_d8d10L3[0]+=abs(vecs[istate,k])**2
            #
            # elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.O_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==x2==-1 and ((abs(x3+1) + abs(y3-0))==1) and ((abs(x4-1) + abs(y4-0))==1 and (x4,y4)!=(0,0)) and ((abs(x5-1) + abs(y5-0))==1 and (x5,y5)!=(0,0)):
            #     wgt_d8Ld10L2[0]+=abs(vecs[istate,k])**2
            #
            # elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.O_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==x2==-1 and ((abs(x3+1) + abs(y3-0))==1 ) and ((abs(x4+1) + abs(y4-0))==1) and ((abs(x5-1) + abs(y5-0))==1 and (x5,y5)!=(0,0)):
            #     wgt_d8L2d10L[0]+=abs(vecs[istate,k])**2
            #
            # elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.O_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==-1 and x2==-1 and ((abs(x3+1) + abs(y3-0))==1) and ((abs(x4+1) + abs(y4-0))==1) and ((abs(x5+1) + abs(y5-0))==1):
            #     wgt_d8L3d10[0]+=abs(vecs[istate,k])**2
            # elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.O_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==1 and x2==1 and ((abs(x3-1) + abs(y3-0))==1) and ((abs(x4-1) + abs(y4-0))==1) and ((abs(x5-1) + abs(y5-0))==1):
            #     wgt_d10d8L3[0]+=abs(vecs[istate,k])**2
            #
            # elif (orb1 in pam.Ni_orbs) and (orb2 in pam.O_orbs) and  (orb3 in pam.O_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==-1 and ((abs(x2-1) + abs(y2-0))==1 and (x2,y2)!=(0,0)) and ((abs(x3-1) + abs(y3-0))==1 and (x3,y3)!=(0,0)) and ((abs(x4-1) + abs(y4-0))==1 and (x4,y4)!=(0,0)) and ((abs(x5-1) + abs(y5-0))==1 and (x5,y5)!=(0,0)):
            #     wgt_d9d10L4[0]+=abs(vecs[istate,k])**2
            #
            # elif (orb1 in pam.Ni_orbs) and (orb2 in pam.O_orbs) and  (orb3 in pam.O_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==-1 and ((abs(x2+1) + abs(y2-0))==1) and ((abs(x3+1) + abs(y3-0))==1 and (x3,y3)!=(-1,0)) and ((abs(x4+1) + abs(y4-0))==1 and (x4,y4)!=(0,0)) and ((abs(x5-1) + abs(y5-0))==1 and (x5,y5)!=(0,0)):
            #     wgt_d9Ld10L3[0]+=abs(vecs[istate,k])**2
            #
            # elif (orb1 in pam.Ni_orbs) and (orb2 in pam.O_orbs) and  (orb3 in pam.O_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==-1 and ((abs(x2+1) + abs(y2-0))==1) and ((abs(x3+1) + abs(y3-0))==1) and ((abs(x4-1) + abs(y4-0))==1 and (x4,y4)!=(0,0)) and ((abs(x5-1) + abs(y5-0))==1 and (x5,y5)!=(0,0)):
            #     wgt_d9L2d10L2[0]+=abs(vecs[istate,k])**2
            #
            # elif (orb1 in pam.Ni_orbs) and (orb2 in pam.O_orbs) and  (orb3 in pam.O_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==-1 and ((abs(x2+1) + abs(y2-0))==1) and ((abs(x3+1) + abs(y3-0))==1 ) and ((abs(x4+1) + abs(y4-0))==1) and ((abs(x5-1) + abs(y5-0))==1 and (x5,y5)!=(0,0)) :
            #     wgt_d9L3d10L[0]+=abs(vecs[istate,k])**2
            #
            # elif (orb1 in pam.Ni_orbs) and (orb2 in pam.O_orbs) and  (orb3 in pam.O_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==-1 and ((abs(x2+1) + abs(y2-0))==1 ) and ((abs(x3+1) + abs(y3-0))==1) and ((abs(x4+1) + abs(y4-0))==1) and ((abs(x5+1) + abs(y5-0))==1):
            #     wgt_d9L4d10[0]+=abs(vecs[istate,k])**2
#             elif (orb1 in pam.Obilayer_orbs):
#                 wgt_s[0]+=abs(vecs[istate,k])**2
#             elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Obilayer_orbs):
...
#             elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and (orb3 in pam.Obilayer_orbs):
...
#             elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and (orb3 in pam.Ni_orbs) and (orb4 in pam.Obilayer_orbs):
...
#             elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and (orb3 in pam.Ni_orbs) and (orb4 in pam.Ni_orbs) and (orb5 in pam.Obilayer_orbs):
...
#                     wgt_dddds[5]+=abs(vecs[istate,k])**2
    ...
    # print('d8L2d9=', wgt_d8L2d9[0]/number)
    ...
    # print('d10d8L3=', wgt_d10d8L3[0]/number)
    #
...
#         print ('s00=',s00)
    ...
    for state_type, type_weight in weight_list:
        print(f'{state_type}: {type_weight/number}')
