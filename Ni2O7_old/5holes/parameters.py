...
Mc = 2
pressure = diff_pressure.pressure  # in Gpa
model = 'a'
...
if Norb == 7 or Norb == 4:
    ...
    if pressure == 0:
        ...
        # tpds = np.linspace(0, 0, num=1, endpoint=True)
        tpps = [0.537]
        # tpps = [0]
    elif pressure == 4:
...
reduce_VS = 1
Sz = 1/2
Sz_list = {1/2: ['dn', 'dn', 'up', 'up', 'up'], 3/2: ['dn', 'up', 'up', 'up', 'up'], 5/2: ['up', 'up', 'up', 'up', 'up']}
Sz_set = Sz_list[Sz]
