        ...
        if s1 == s2:
            ...
            if o1 == o2:
                ...
                # instead of e1e1 and e2e2
                    ...
                    if idx[i] == 3456:
                        slabel = [s1, 'dyz'] + dpos + [s2, 'dyz'] + dpos + hole3456_part[i][0:20]
                    elif idx[i] == 2456:
                        ...
                        slabel = ([s1, 'dyz'] + dpos + hole3456_part[i][0:10] + [s2, 'dyz'] + dpos + hole3456_part[i][10:20])
                    elif idx[i] == 1256:
                        slabel = (hole3456_part[i][0:10] + [s1, 'dyz'] + dpos + [s2, 'dyz'] + dpos + hole3456_part[i][10:20])
                    elif idx[i] == 1236:
                        ...
                        slabel = hole3456_part[i][0:10] + [s1, 'dyz'] + dpos + hole3456_part[10:20] + [s2, 'dyz'] + dpos
                    elif idx[i] == 1235:
                        slabel = hole3456_part[i][0:15] + [s1, 'dyz'] + dpos + hole3456_part[15:20] + [s2, 'dyz'] + dpos
                    elif idx[i] == 1234:
...
def create_bonding_anti_bonding_basis_change_matrix(VS):
    ...
    for i in range(0, VS.dim):
        ...
        slabel2 = [s1, orb1, -x1, y1, z1, s2, orb2, -x2, y2, z2, s3, orb3, -x3, y3, z3,
                   s4, orb4, -x4, y4,z4, s5, orb5, -x5, y5, z5, s6, orb6, -x6, y6, z6]
