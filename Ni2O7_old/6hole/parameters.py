...
As = np.arange(7.0, 7.01, 2.0)
B = 0.15
C = 0.58
# As = np.arange(3.577, 3.58, 2.0)
# B = 0.19
# C = 0.644
...
reduce_VS = 1
Sz = 0
Sz_list = {0: ['dn', 'dn', 'dn', 'up', 'up', 'up'], 1: ['dn', 'dn', 'up', 'up', 'up', 'up'],
           2: ['dn', 'up', 'up', 'up', 'up', 'up'], 3: ['up', 'up', 'up', 'up', 'up', 'up']}
Sz_set = Sz_list[Sz]
