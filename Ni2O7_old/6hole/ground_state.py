...
def state_classification(state_param):
    ...
    for (orb, x, y) in state_param:
        ...
        if orb in pam.O_orbs:
            ...
            if (x, y) in [(2, 0), (1, 1), (1, -1)]:
                num_in_right_O += 1
    O_num_to_str = {1: 'L', 2: 'L2', 3: 'L3', 4: 'L4', 5: 'L5'}
...
def get_ground_state(matrix, VS, S_Ni1_val, Sz_Ni1_val, S_Ni2_val, Sz_Ni2_val, bonding_val):
    ...
    for i in range(dim):
        ...
        if weight > 0.01:
            print (' state ', istate, ' ',orb1,s1,x1,y1,z1,' ',orb2,s2,x2,y2,z2,' ',orb3,s3,x3,y3,z3,' ',
                   orb4,s4,x4,y4,z4,' ',orb5,s5,x5,y5,z5,' ', orb6, s6, x6, y6, z6,
               '\n S_Ni1=', S_Ni1_val[istate], ',  Sz_Ni1=', Sz_Ni1_val[istate],
               ',  S_Ni2=', S_Ni2_val[istate], ',  Sz_Ni2=', Sz_Ni2_val[istate], ',bonding=',bonding,
               ", weight = ", weight,'\n')
            txt.write(f'state {istate}:  {orb1} {s1} {x1} {y1} {z1}  {orb2} {s2} {x2} {y2} {z2}  {orb3} {s3} {x3} {y3} {z3}  '
                      f'{orb4} {s4} {x4} {y4} {z4}  {orb5} {s5} {x5} {y5} {z5}  {orb6} {s6} {x6} {y6} {z6}\n'
                      f'S_Ni1 = {S_Ni1_val[istate]},  Sz_Ni1 = {Sz_Ni1_val[istate]},  S_Ni2 = {S_Ni2_val[istate]},  Sz_Ni2 = {Sz_Ni2_val[istate]}'
                      f'  bonding = {bonding},  weight = {weight}\n\n')

        input_state = [(orb1, x1, y1), (orb2, x2, y2), (orb3, x3, y3), (orb4, x4, y4), (orb5, x5, y5), (orb6, x6, y6)]
    ...
    t2 = time.time()
    print(f'Time used for getting ground state = {t2-t1} s')
